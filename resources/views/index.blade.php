<section class="py-24 bg-blueGray-50 overflow-hidden">
  <div class="container px-4 mx-auto">
    <h2 class="mb-5 text-6xl md:text-8xl xl:text-10xl text-center font-bold font-heading font-heading tracking-px-n leading-none">Featured projects</h2>
    ...
    <div class="md:max-w-6xl mx-auto">
      ...
      <Link class="flex justify-center items-center text-center font-semibold text-indigo-600 hover:text-indigo-700 leading-normal" href="{{ route('projects.index') }}">
        <span class="mr-2.5">See all 8,849 projects</span>
