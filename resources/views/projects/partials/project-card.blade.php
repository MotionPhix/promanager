<x-splade-link class="relative p-4 bg-white overflow-hidden border border-gray-200 rounded-lg hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700 shadow-md transition duration-300" href="{{ route('projects.show', $project) }}">
