<section
  class="relative flex flex-col p-4 bg-white overflow-hidden border border-gray-200 rounded-lg hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700 shadow-md transition duration-300">

  <x-splade-link href="{{ route('projects.show', $project) }}" preserve-scroll>
  ...
  <footer class="flex items-center justify-between border-t mt-4 pt-4">
