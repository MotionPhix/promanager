...
<SpladeModal {{ $baseAttributes->mergeVueBinding(':close-button', $closeButton) }} :name="@js($name)">
  <template #default="modal">
    <x-splade-component is="transition" show="modal.isOpen">
      ...
      <x-splade-component is="dialog" v-bind:dusk="`modal.${modal.stack}`" class="relative z-20">
        ...
        <div v-if="(modal.stack === 1 && !modal.animate) || (modal.stack > 1 && modal.onTopOfStack)" class="fixed z-30 inset-0 bg-black/75" />
